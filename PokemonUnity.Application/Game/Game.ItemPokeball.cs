...
{
	public partial class Game //: PokemonEssentials.Interface.BallHandlers
	{
		...
		public int ModifyCatchRate(object sender) {
			Items ball = Items.NONE;
			int catchRate = -1;
			IBattle battle = null;
		...
		protected virtual void OnCatch(object sender, OnCatchEventArgs e) {
			//if (!OnCatch[ball]) return;
			//OnCatch.trigger(ball,battle,pokemon);
		...
		protected virtual void OnFailCatch(object sender, OnFailCatchEventArgs e) {
