...
namespace PokemonUnity.Inventory
{
	/*public partial class Item
	{
		...
		{
			ItemId = itemId;
			ItemData item = Game.ItemData[itemId];
			this.Price = item.Price;
			this.ItemCategory = item.Category;
			//this.ItemFlag = item.Flags;
			this.ItemFlingEffect = item.FlingEffect;
		...
		private Item(Items itemId, ItemCategory itemCategory = ItemCategory.UNUSED, /*BattleType battleType, string description,* / int price = 0, int? flingPower = null,
			ItemFlingEffect? itemEffect = null, /*string stringParameter, float floatParameter,* / ItemFlag flags = new ItemFlag())
		{
			//this.name = name;
