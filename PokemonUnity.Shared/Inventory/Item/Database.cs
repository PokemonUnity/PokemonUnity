...
new Item(Items.CHERI_BERRY,         ItemCategory.MEDICINE,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.CHESTO_BERRY,        ItemCategory.MEDICINE,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.PECHA_BERRY,         ItemCategory.MEDICINE,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.RAWST_BERRY,         ItemCategory.MEDICINE,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.ASPEAR_BERRY,        ItemCategory.MEDICINE,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.LEPPA_BERRY,         ItemCategory.MEDICINE,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.ORAN_BERRY,          ItemCategory.MEDICINE,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.PERSIM_BERRY,        ItemCategory.MEDICINE,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.LUM_BERRY,           ItemCategory.MEDICINE,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.SITRUS_BERRY,        ItemCategory.MEDICINE,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.FIGY_BERRY,          ItemCategory.PICKY_HEALING,   20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.WIKI_BERRY,          ItemCategory.PICKY_HEALING,   20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.MAGO_BERRY,          ItemCategory.PICKY_HEALING,   20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.AGUAV_BERRY,         ItemCategory.PICKY_HEALING,   20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.IAPAPA_BERRY,        ItemCategory.PICKY_HEALING,   20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
...
new Item(Items.LIECHI_BERRY,        ItemCategory.IN_A_PINCH,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.GANLON_BERRY,        ItemCategory.IN_A_PINCH,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.SALAC_BERRY,         ItemCategory.IN_A_PINCH,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.PETAYA_BERRY,        ItemCategory.IN_A_PINCH,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.APICOT_BERRY,        ItemCategory.IN_A_PINCH,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.LANSAT_BERRY,        ItemCategory.IN_A_PINCH,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.STARF_BERRY,         ItemCategory.IN_A_PINCH,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
new Item(Items.ENIGMA_BERRY,        ItemCategory.OTHER,         20, 10, null, new ItemFlags(holdableActive: true)),
new Item(Items.MICLE_BERRY,         ItemCategory.IN_A_PINCH,      20, 10, ItemFlingEffect.USE_BERRY, new ItemFlags(holdableActive: true)),
...
new Item(Items.WHITE_HERB,          ItemCategory.HELD_ITEMS,        100, 10, ItemFlingEffect.USE_HERB, new ItemFlags(holdable: true,holdableActive: true)),
...
new Item(Items.MENTAL_HERB,         ItemCategory.HELD_ITEMS,        100, 10, ItemFlingEffect.USE_HERB, new ItemFlags(holdable: true,holdableActive: true)),
new Item(Items.CHOICE_BAND,         ItemCategory.CHOICE,            100, 10, null, new ItemFlags(holdable: true,holdableActive: true)),
new Item(Items.KINGS_ROCK,          ItemCategory.HELD_ITEMS,        100, 30, ItemFlingEffect.FLINCH, new ItemFlags(holdable: true,holdableActive: true)),
...
new Item(Items.LIGHT_BALL,          ItemCategory.SPECIES_SPECIFIC,100, 30, ItemFlingEffect.PARALYZES, new ItemFlags(holdable: true)),
...
new Item(Items.POISON_BARB,         ItemCategory.TYPE_ENHANCEMENT,100, 70, ItemFlingEffect.POISONS, new ItemFlags(holdable: true,holdableActive: true)),
...
new Item(Items.TOXIC_ORB,           ItemCategory.BAD_HELD_ITEMS,  100, 30, ItemFlingEffect.BADLY_POISONS, new ItemFlags(holdable: true,holdableActive: true)),
new Item(Items.FLAME_ORB,           ItemCategory.BAD_HELD_ITEMS,  100, 30, ItemFlingEffect.BURNS, new ItemFlags(holdable: true,holdableActive: true)),
...
new Item(Items.RAZOR_FANG,          ItemCategory.HELD_ITEMS,        2100, 30, ItemFlingEffect.FLINCH, new ItemFlags(holdable: true,holdableActive: true)),
