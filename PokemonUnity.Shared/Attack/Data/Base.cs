...
namespace PokemonUnity.Attack.Data
{
	...
	public enum Effects
	{
		...
		x144 = 324,
		/// <summary>
		/// With [Grass Pledge]{move:grass-pledge}, halves opposing Pokémon's Speed for four turns.<para></para> Inflicts [regular damage]{mechanic:regular-damage}.  If a friendly Pokémon used <seealso cref="Moves.GRASS_PLEDGE"/> earlier this turn, all opposing Pokémon have halved [Speed]{mechanic:speed} for four turns (including this one).
		/// </summary>
		x145 = 325,
		/// <summary>
		/// With [Water Pledge]{move:water-pledge}, doubles the effect chance of friendly Pokémon's moves for four turns.<para></para> Inflicts [regular damage]{mechanic:regular-damage}.  If a friendly Pokémon used <seealso cref="Moves.WATER_PLEDGE"/> earlier this turn, moves used by any friendly Pokémon have doubled effect chance for four turns (including this one).
		/// </summary>
		x146 = 326,
		/// <summary>
		/// With [Fire Pledge]{move:fire-pledge}, damages opposing Pokémon for 1/8 their max HP every turn for four turns.<para></para> Inflicts [regular damage]{mechanic:regular-damage}.  If a friendly Pokémon used <seealso cref="Moves.FIRE_PLEDGE"/> earlier this turn, all opposing Pokémon will take 1/8 their max [HP]{mechanic:hp} in damage at the end of every turn for four turns (including this one).
		/// </summary>
		x147 = 327,
		/// <summary>
		...
		x14F = 335,
		/// <summary>
		/// With [Fusion Bolt]{move:fusion-bolt}, inflicts double damage.<para></para> Inflicts [regular damage]{mechanic:regular-damage}.  If a friendly Pokémon used <seealso cref="Moves.FUSION_BOLT"/> earlier this turn, this move has double power.
		/// </summary>
		x150 = 336,
		/// <summary>
		/// With [Fusion Flare]{move:fusion-flare}, inflicts double damage.<para></para> Inflicts [regular damage]{mechanic:regular-damage}.  If a friendly Pokémon used <seealso cref="Moves.FUSION_FLARE"/> earlier this turn, this move has double power.
		/// </summary>
		x151 = 337,
		/// <summary>
		...
		/// 
		/// After the user eats a berry, it may use this move any number of times until the end of the battle, even if it switches out.  Eating a held berry, eating a berry via <seealso cref="Moves.BUG_BITE"/> or <seealso cref="Moves.PLUCK"/>, or being the target of a [Flung]{move:fling} berry will enable this move.  Feeding a Pokémon a berry from the bag or using <seealso cref="Moves.NATURAL_GIFT"/> will not.
		/// 
		...
		x714 = 10004,
		/// <summary>
		/// Removes [Light Screen]{move:light-screen}, [Reflect]{move:reflect}, and [Safeguard]{move:safeguard}.<para></para> Removes the effects of <seealso cref="Moves.LIGHT_SCREEN"/>, <seealso cref="Moves.REFLECT"/>, and <seealso cref="Moves.SAFEGUARD"/>.
		/// </summary>
		x715 = 10005,
		/// <summary>
		/// Changes the weather to Shadow Sky for five turns.<para></para> Changes the weather to Shadow Sky for five turns.  Pokémon other than <seealso cref="Types.SHADOW"/> Pokémon take 1/16 their max [HP]{mechanic:hp} at the end of every turn.  This move is typeless for the purposes of <seealso cref="Moves.WEATHER_BALL"/>.
		/// </summary>
		x716 = 10006
	}
}