...
public class PokeBattle_BattleArena : Battle{
  ...
  public PokeBattle_BattleArena(IPokeBattleArena_Scene scene, Monster.Pokemon[] p1, Monster.Pokemon[] p2, Combat.Trainer[] player, Combat.Trainer[] opponent) : base (scene, p1, p2, player, opponent) { 
