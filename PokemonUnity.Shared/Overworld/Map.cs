...
namespace PokemonUnity
{
	public struct MapData
    {
        ...
        public List<int> encounter_list         { get; private set; }
...
/// functions. Refer to <see cref="Game.GameData.GameMap"/> for the instance of this class.
/// </summary>
public partial class Game_Map {
  ...
  public int mapsInRange				        { get; set; }
        ...
        private int fog_opacity_target;
  ...
  public void setup(int map_id) {
    ...
    //tileset = Game.GameData.DataTilesets[@map.tileset_id];
    ...
    //for (int i = 1; i < Game.GameData.DataCommonEvents.size; i++) {
  ...
  public List<int> encounter_list { get {
...
// -----------------------------------------------------------------------------
  ...
  //      pbCueBGM(@map.bgm.name+"n",1.0f,@map.bgm.volume,@map.bgm.pitch);
  //    } else {
  //      pbCueBGM(@map.bgm,1.0f);
  //    }
  //  }
  //  if (@map.autoplay_bgs) {
  //    pbBGSPlay(@map.bgs);
...
//      }
  ...
  public void start_fog_opacity_change(float opacity,int duration) {
    @fog_opacity_target = opacity * 1.0f;
  ...
  public void update() {
    ...
    if (@scroll_rest > 0) {
      int distance = Math.Pow(2, @scroll_speed);
...
public partial class Game_Map {
  ...
  //  }
  //  if (Game.GameData.MapFactory) Game.GameData.MapFactory.setMapsInRange;
  //} }
  //
