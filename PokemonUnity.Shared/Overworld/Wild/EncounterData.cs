...
namespace PokemonUnity.Overworld
{
	...
	public struct EncounterData
	{
		...
		public EncounterData(int id, int area, Method method, int slotId, Pokemons[] pokemon = null, ConditionValue[] conditions = null, int generation = 0, int minLevel = 1, int maxLevel = 1, int rarity = 0, Versions[] versions = null)
		{
			Id = id;
			Area = area;
		...
		//{
			/*ToDo: Copied from Pokemon PickUp Ability function, Reuse for Wild Encounter?
