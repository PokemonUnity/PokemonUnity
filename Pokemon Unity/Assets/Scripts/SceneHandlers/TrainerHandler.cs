...
namespace PokemonUnity.Legacy
{
	public class TrainerHandler : MonoBehaviour
	{
		...
		public UnityEngine.Sprite cancelTex;
		public UnityEngine.Sprite cancelHighlightTex;
			...
			if (interactingScreen)
			{
				...
				if (SaveData.currentSave.gymsEncountered[currentBadge])
				{
					if (currentBadge == 0)
					{
						...
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typeROCK");
					}
					else if (currentBadge == 1)
					{
						GLPicture.sprite = null;
						GLNameData.text = "Bob";
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typeNORMAL");
					}
					else if (currentBadge == 2)
					{
						GLPicture.sprite = null;
						GLNameData.text = "Avery";
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typeFLYING");
					}
					else if (currentBadge == 3)
					{
						GLPicture.sprite = null;
						GLNameData.text = "Linda";
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typeGRASS");
					}
					else if (currentBadge == 4)
					{
						GLPicture.sprite = null;
						GLNameData.text = "Cole";
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typeFIRE");
					}
					else if (currentBadge == 5)
					{
						GLPicture.sprite = null;
						GLNameData.text = "Brooke";
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typeWATER");
					}
					else if (currentBadge == 6)
					{
						GLPicture.sprite = null;
						GLNameData.text = "Doug";
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typeGROUND");
					}
					else if (currentBadge == 7)
					{
						GLPicture.sprite = null;
						GLNameData.text = "Apalala";
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typeDRAGON");
					}
					else if (currentBadge == 8)
					{
						GLPicture.sprite = null;
						GLNameData.text = "Zinka";
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typeSTEEL");
					}
					else if (currentBadge == 9)
					{
						GLPicture.sprite = null;
						GLNameData.text = "";
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typePSYCHIC");
					}
					else if (currentBadge == 10)
					{
						GLPicture.sprite = null;
						GLNameData.text = "";
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typeGHOST");
					}
					else if (currentBadge == 11)
					{
						GLPicture.sprite = null;
						GLNameData.text = "";
						GLType.sprite = Resources.Load<UnityEngine.Sprite>("PCSprites/typeDARK");
					}
