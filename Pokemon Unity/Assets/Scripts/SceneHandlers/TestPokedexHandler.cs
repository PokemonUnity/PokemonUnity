...
public class TestPokedexHandler : MonoBehaviour
{
    ...
    private void updateSelectedInfo(Pokemon selectedPokemonOld)
    {
        if (!carrying)
        {
            ...
            {
                selectedName.text = selectedPokemonOld.Name;
                ...
                //}
                selectedLevel.text = "Level " + selectedPokemonOld.Level;
    ...
    {
        //Texture item = icon.transform.Find("Item").GetComponent<GUITexture>();
