...
public class MapSettings : MonoBehaviour {
	...
	public Pokemon getRandomEncounter(WildPokemonInitialiser.Location location){
		...
		int listIndex = 0;
		for(int i = 0; i < list.Length; i++){ //loop through each position of list
			for(int i2 = 0; i2 < list[i].encounterLikelihood; i2++){ //add encounter once for every Likelihood
