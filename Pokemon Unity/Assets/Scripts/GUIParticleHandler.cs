...
namespace PokemonUnity.Legacy
{
	public class GUIParticleHandler : MonoBehaviour
	{
		...
		public Image createParticle(UnityEngine.Sprite particleSprite, Vector2 position, Vector2 destinationPosition, float size = 0f, 
		...
		private Image setUpParticle(int targetParticle, UnityEngine.Sprite particleSprite, Vector2 position, float size, float angle,
			float duration,
