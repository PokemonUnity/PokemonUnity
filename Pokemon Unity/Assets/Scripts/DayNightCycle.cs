...
public class DayNightCycle : MonoBehaviour {
	...
	private IEnumerator SetTimeColor(){ //repeat every second
		while(true){
			...
			if(!debugIgnoreTime){
				lightSource.color = new Color(r,g,b,1)*filter;} 	//set light to be appropriately between the two points.
