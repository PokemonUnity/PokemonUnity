...
public class DayNightCycle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        skyLight = new Color[24]
        {
            ...
            new Color(0.63f, 0.75f, 1, 1), new Color(0.63f, 0.75f, 1, 1), new Color(0.85f, 0.85f, 0.85f, 1f), new Color(0.85f, 0.85f, 0.85f, 1f),
            new Color(0.85f, 0.85f, 0.85f, 1f), new Color(1, 1, 1, 1), new Color(1, 1, 1, 1), new Color(1, 1, 1, 1),
