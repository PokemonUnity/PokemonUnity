...
namespace PokemonUnity.Legacy
{
	public class NonResettingHandler : MonoBehaviour
	{
		...
		public void Run()
		{
			...
			int sceneNonResettingListIndex = SaveData.currentSave.getNonResettingListIndex(UnityEngine.Application.loadedLevelName);
		...
		private NonResettingList compileListOfNonResetters()
		{
			...
			return new NonResettingList(UnityEngine.Application.loadedLevelName, sceneTrainers, sceneTrainersActive, sceneItems, sceneEvents, sceneFollowerEvents);
		}
