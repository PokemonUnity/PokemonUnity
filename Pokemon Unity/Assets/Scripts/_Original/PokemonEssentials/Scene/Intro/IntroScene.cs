...
namespace PokemonUnity
{
	public class IntroScene : EventScene, IIntroEventScene
	{
        ...
        void IIntroEventScene.openPic() {
            throw new NotImplementedException();
        }

        void IIntroEventScene.timer() {
            throw new NotImplementedException();
        }

        void IIntroEventScene.closePic() {
            throw new NotImplementedException();
        }

        void IIntroEventScene.openSplash() {
            throw new NotImplementedException();
        }

        void IIntroEventScene.splashUpdate() {
            throw new NotImplementedException();
        }

        void IIntroEventScene.closeSplash() {
            throw new NotImplementedException();
        }

        void IIntroEventScene.closeSplashDelete() {
            throw new NotImplementedException();
        }
    }
}