...
namespace PokemonUnity {
	public class EventScene : MonoBehaviour, IEventScene {
        ...
        bool IEventScene.onATrigger { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        bool IEventScene.onBTrigger { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        bool IEventScene.onUpdate { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
