...
public static class GameDebug //: IDebugger
{
	...
	static void _Log(string message)
	{
		...
		UnityEngine.Debug.Log(UnityEngine.Time.frameCount + ": " + message);
		//if (logFile != null)
	...
	static void _LogWarning(string message)
	{
		...
		UnityEngine.Debug.LogWarning("[WARN] " + UnityEngine.Time.frameCount + message);
		//if (logFile != null)
	...
	static void _LogError(string message)
	{
		...
		UnityEngine.Debug.LogError("[ERR] " + UnityEngine.Time.frameCount + message);
		//if (logFile != null)
