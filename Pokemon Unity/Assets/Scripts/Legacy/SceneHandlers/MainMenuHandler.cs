...
namespace PokemonUnity.Legacy
{
	public class MainMenuHandler : MonoBehaviour
	{
		...
		public UnityEngine.Sprite buttonSelectedSprite;
		public UnityEngine.Sprite buttonDimmedSprite;
		public UnityEngine.Sprite maleSprite;
		public UnityEngine.Sprite femaleSprite;
			...
			while (running)
			{
				if (UnityEngine.Input.GetButtonDown("Select"))
				{
					if (selectedButton == 0)
					{
						...
						UnityEngine.Application.LoadLevel(SaveData.currentSave.levelName);
					}
					else if (selectedButton == 1)
					{
						...
						GlobalVariables.global.fadeIn = true;
						UnityEngine.Application.LoadLevel("route_3");
				...
				else if (UnityEngine.Input.GetKeyDown(KeyCode.Delete))
				{
					...
					if (UnityEngine.Input.GetKey(KeyCode.Delete) && !released)
					{
