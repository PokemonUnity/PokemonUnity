...
{ 
    ...
    {
        var data = new Dictionary<int, PokemonData>();
    ...
    public static PokedexTranslation GetPokedexTranslation(int id)
    {
        if (_pokeTranslations == null)
        {
            LoadPokedexTranslations();
        }

        if (_pokeTranslations.ContainsKey(id) == false)
        {
