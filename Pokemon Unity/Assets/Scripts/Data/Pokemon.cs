...
namespace PokemonUnity.Legacy
{
	...
	public class Pokemon
	{
			...
			string nature, int ability, string[] moveset, int[] PPups)
		{
			...
			Debug.Log(PokemonDatabase.getPokemon(pokemonID));
		...
		public string getName()
		{
			...
			{
				return Language.getPokemonName(getID());
			}
			else
			{
				return nickname;
		...
		public UnityEngine.Sprite[] GetFrontAnim_()
		{
			return GetAnimFromID2_("PokemonSprites/Front", pokemonID, gender, isShiny);
		}

		public UnityEngine.Sprite[] GetBackAnim_()
		{
			return GetAnimFromID2_("PokemonSprites/Back", pokemonID, gender, isShiny);
		}


		public static UnityEngine.Sprite[] GetFrontAnimFromID_(int ID, Gender gender, bool isShiny)
		{
			return GetAnimFromID2_("PokemonSprites/Front", ID, gender, isShiny);
		}

		public static UnityEngine.Sprite[] GetBackAnimFromID_(int ID, Gender gender, bool isShiny)
		{
			return GetAnimFromID2_("PokemonSprites/Back", ID, gender, isShiny);
		}
	
		private static UnityEngine.Sprite[] GetAnimFromID_(string folder, int ID, Gender gender, bool isShiny)
		{
			UnityEngine.Sprite[] animation;

			string shiny = (isShiny) ? "s" : "";
			if (gender == Gender.FEMALE)
			{
				//Attempt to load Female Variant
				animation = Resources.LoadAll<UnityEngine.Sprite>(folder + "/" + convertLongID(ID) + "f" + shiny + "/");
				if (animation.Length == 0)
				{
					Debug.LogWarning("Female Variant NOT Found");
					//Attempt to load Base Variant (possibly Shiny)
					animation = Resources.LoadAll<UnityEngine.Sprite>(folder + "/" + convertLongID(ID) + shiny + "/");
				}
			...
			if (animation.Length == 0 && isShiny)
			{
				...
				animation = Resources.LoadAll<UnityEngine.Sprite>(folder + "/" + convertLongID(ID) + "/");
			}
	
			for (int i = 0; i < animation.Length; ++i)
			{
				animation[i] = UnityEngine.Sprite.Create(animation[i].texture, animation[i].rect, new Vector2(0.5f, 0), 16f);
			}
		
			return animation;
		}

		private static UnityEngine.Sprite[] GetAnimFromID2_(string folder, int ID, Gender gender, bool isShiny)
		{
			UnityEngine.Sprite[] animation;
			...
			{
				//Attempt to load Female Variant
				animation = Resources.LoadAll<UnityEngine.Sprite>(folder + (isShiny ? "Shiny" : "") + "/" + convertLongID(ID) + "f" + shiny + "/");
				if (animation.Length == 0)
				{
					Debug.LogWarning("Female Variant NOT Found");
					//Attempt to load Base Variant (possibly Shiny)
			...
			{
				//Attempt to load Base Variant (possibly Shiny)
				animation = Resources.LoadAll<UnityEngine.Sprite>(folder  + (isShiny ? "Shiny" : "")  + "/" + convertLongID(ID) + shiny + "/");
			}
			if (animation.Length == 0 && isShiny)
			{
				Debug.LogWarning("Shiny Variant NOT Found");
			...
			if (animation.Length == 0)
			{
				animation = Resources.LoadAll<UnityEngine.Sprite>("PokemonSprites/Missing");
			}
		...
		public UnityEngine.Sprite[] GetIcons_()
		{
			return GetIconsFromID_(pokemonID, isShiny);
		}

		public static UnityEngine.Sprite[] GetIconsFromID_(int ID, bool isShiny)
		{
			string shiny = (isShiny) ? "s" : "";
			UnityEngine.Sprite[] icons = Resources.LoadAll<UnityEngine.Sprite>("PokemonIcons/icon" + convertLongID(ID) + shiny);
			if (icons == null)
			{
				Debug.LogWarning("Shiny Variant NOT Found");
				icons = Resources.LoadAll<UnityEngine.Sprite>("PokemonIcons/icon" + convertLongID(ID));
			}
			return icons;
		}
		...
		{
			AudioClip c = Resources.Load<AudioClip>("Audio/cry/" + convertLongID(ID));
			if (c != null)
			{
				return c;
			}
			return Resources.Load<AudioClip>("Audio/cry/001");
		}
		...
		public UnityEngine.Sprite GetIcons()
		{
			return GetIconsFromID(pokemonID, isShiny);
		}
	
		public UnityEngine.Sprite[] GetIconsSprite()
		{
			return GetIconsSpriteFromID(pokemonID, isShiny);
		}

		public UnityEngine.Sprite[] GetSprite(bool getLight)
		{
			return GetSpriteFromID(pokemonID, isShiny, getLight);
		}
	
		public UnityEngine.Sprite[] GetNewSprite(bool getLight)
		{
			return GetNewSpriteFromID(pokemonID, isShiny, getLight);
		}
		...
		public static UnityEngine.Sprite GetIconsFromID(int ID, bool isShiny)
		{
			string shiny = (isShiny) ? "s" : "";
			UnityEngine.Sprite icons = Resources.Load<UnityEngine.Sprite>("PokemonIcons/icon" + convertLongID(ID) + shiny);
			if (icons == null)
			{
				Debug.LogWarning("Shiny Variant NOT Found");
				icons = Resources.Load<UnityEngine.Sprite>("PokemonIcons/icon" + convertLongID(ID));
			}
			return icons;
		}
	
		public static UnityEngine.Sprite[] GetIconsSpriteFromID(int ID, bool isShiny)
		{
			string shiny = (isShiny) ? "s" : "";
			UnityEngine.Sprite[] icons = Resources.LoadAll<UnityEngine.Sprite>("PokemonIcons/icon" + convertLongID(ID) + shiny);
			if (icons == null)
			...
			if (icons.Length == 0)
			{
				Debug.LogWarning("Icon NOT Found");
				icons = Resources.LoadAll<UnityEngine.Sprite>("PokemonIcons/icon001");
			}
		...
		public static UnityEngine.Sprite[] GetSpriteFromID(int ID, bool isShiny, bool getLight)
		{
			string shiny = (isShiny) ? "s" : "";
			string light = (getLight) ? "Lights/" : "";
			UnityEngine.Sprite[] spriteSheet = Resources.LoadAll<UnityEngine.Sprite>("OverworldPokemonSprites/" + light + convertLongID(ID) + shiny);
			if (spriteSheet.Length == 0)
			{
				...
				spriteSheet = Resources.LoadAll<UnityEngine.Sprite>("OverworldPokemonSprites/" + light + convertLongID(ID));
			}
			if (spriteSheet.Length == 0)
			{
				//No Light found OR No UnityEngine.Sprite found, return 8 blank sprites
				if (!getLight)
				{
				...
				return new UnityEngine.Sprite[8];
			}
			return spriteSheet;
		}
	
		public static UnityEngine.Sprite[] GetNewSpriteFromID(int ID, bool isShiny, bool getLight)
		{
			string shiny = (isShiny) ? "s" : "";
			string light = (getLight) ? "Lights/" : "";
			UnityEngine.Sprite[] spriteSheet;
			if (getLight)
			{
				spriteSheet = Resources.LoadAll<UnityEngine.Sprite>("OWPokemonSprites/" + light + convertLongID(ID) + shiny + "_0");
			}
			else
			{
				spriteSheet = Resources.LoadAll<UnityEngine.Sprite>("OWPokemonSprites/" + convertLongID(ID) + shiny + "_0");
			}
			...
			if (spriteSheet.Length == 0)
			{
				...
				spriteSheet = Resources.LoadAll<UnityEngine.Sprite>("OWPokemonSprites/" + light + convertLongID(ID) + "_0");
			}
			if (spriteSheet.Length == 0)
			{
				//No Light found OR No UnityEngine.Sprite found, return 8 blank sprites
				...
				spriteSheet =  Resources.LoadAll<UnityEngine.Sprite>("OWPokemonSprites/001_0");
			}
		
			for (int i = 0; i < spriteSheet.Length; ++i)
			{
				spriteSheet[i] = UnityEngine.Sprite.Create(spriteSheet[i].texture, spriteSheet[i].rect, new Vector2(0.5f, 0), 16f);
			}
