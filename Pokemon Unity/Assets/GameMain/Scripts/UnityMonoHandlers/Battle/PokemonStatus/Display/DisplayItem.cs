...
namespace PokemonUnity //.Battle.Pokemon
{
	public class DisplayItem : MonoBehaviour
	{
		...
		public void Init(Entity owner, Canvas parentCanvas, float fromHPRatio, float toHPRatio)
		{
			...
			StartCoroutine(DisplayCo(toHPRatio, AnimationSeconds, KeepSeconds, FadeOutSeconds));
		}
		...
		private IEnumerator DisplayCo(float value, float animationDuration, float keepDuration, float fadeOutDuration)
		{
			yield return m_Display.SmoothValue(value, animationDuration);
