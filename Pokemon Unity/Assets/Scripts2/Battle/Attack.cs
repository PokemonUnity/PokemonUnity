...
public class Function
{
	...
	public class PokeBattle_Move_01C : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.ATTACK,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_01D : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.DEFENSE,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_01F : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.SPEED,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_020 : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.SPATK,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_022 : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.EVASION,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_02E : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.ATTACK,2,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_02F : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.DEFENSE,2,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_030 : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.SPEED,2,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_032 : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.SPATK,2,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_033 : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.SPDEF,2,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_034 : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.EVASION,2,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_037 : PokeBattle_Move
	{
		...
		array.Add(i) if opponent.pbCanIncreaseStatStage(i, attacker,false,this)
		}
		if (array.Length==0){
	...
	public class PokeBattle_Move_038 : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.DEFENSE,3,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_039 : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.SPATK,3,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_042 : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.ATTACK,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_043 : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.DEFENSE,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_044 : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.SPEED,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_045 : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.SPATK,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_046 : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.SPDEF,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_047 : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.ACCURACY,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_048 : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.EVASION, increment, attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_049 : PokeBattle_Move
	{
		...
		if (Settings.USENEWBATTLEMECHANICS){
		  opponent.OpposingSide.effects.Reflect     = 0;

		  opponent.OpposingSide.effects.LightScreen = 0;

		  opponent.OpposingSide.effects.Mist        = 0;

		  opponent.OpposingSide.effects.Safeguard   = 0;

		  opponent.OpposingSide.effects.Spikes      = 0;

		  opponent.OpposingSide.effects.StealthRock = false;

		  opponent.OpposingSide.effects.StickyWeb   = false;

		  opponent.OpposingSide.effects.ToxicSpikes = 0;
	...
	public class PokeBattle_Move_04B : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.ATTACK,2,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_04C : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.DEFENSE,2,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_04D : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.SPEED, increment, attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_04E : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.SPATK,2,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_04F : PokeBattle_Move
	{
		...
		object ret=opponent.pbReduceStat(Stats.SPDEF,2,attacker,false,this);
		return ret? 0 : -1;
	  }
	...
	public class PokeBattle_Move_06F : PokeBattle_Move
	{
		...
		int dmg = Math.Max((attacker.level * Math.Floor(this.battle.pbRandom(101) + 50f) / 100f), 1);
	...
	public class PokeBattle_Move_083 : PokeBattle_Move
	{
		...
		object ret=basedmg;
		(attacker.OwnSide.Round.times){ // do; do => while or...
	...
	public int[] pbHiddenPower(byte iv){
	byte powermin = 30;
	byte powermax = 70;
	  int type=0; int baseY = 0;
	List<Types> types = List<Types>();
	  for (int i = 0; i < BTypes.maxValue; i++){
	...
	public class PokeBattle_Move_094 : PokeBattle_Move
	{
	  ...
	  public override object pbEffect(Battle.Battler attacker, Battle.Battler opponent, byte hitnum= 0, byte? alltargets= null, bool showanimation= true)
	  {
		...
		if (r < 4)
		  ...
		  opponent.RecoverHP(Math.Floor(opponent.TotalHP/4f),true);
	...
	public class PokeBattle_Move_0B3 : PokeBattle_Move
	{
		...
		int target = (Settings.USENEWBATTLEMECHANICS && opponent) ? opponent.Index : -1;
	...
	public class PokeBattle_Move_0B5 : PokeBattle_Move
	{
		...
		for (int i = 0; i < party.Length; i++){ 
		  if (i!=attacker.pokemonIndex && party[i] && !(Settings.USENEWBATTLEMECHANICS && party[i].isEgg)){
	...
	public class PokeBattle_Move_0C0 : PokeBattle_Move
	{
	  ...
	  public object pbNumHits(Battle.Battler attacker){
		hitchances =new int[] { 2, 2, 3, 3, 4, 5 };
	...
	public class PokeBattle_Move_0C1 : PokeBattle_Move
	{
	  ...
	  public object pbOnStartUse(Battle.Battler attacker){
		...
		for (int i = 0; i < party.Length; i++){ 
		  ...
		  } else if (party[i] && !party[i].isEgg && party[i].HP>0 && party[i].status==0) {
			this.participants.Add(i);
		  }
	...
	public class PokeBattle_Move_0D5 : PokeBattle_Move
	{
	  ...
	  public override object pbEffect(Battle.Battler attacker, Battle.Battler opponent, byte hitnum=0, byte? alltargets=null, bool showanimation=true){
		...
		attacker.RecoverHP(Math.Floor((attacker.TotalHP+1)/2),true);
	...
	public class PokeBattle_Move_0D9 : PokeBattle_Move
	{
	  ...
	  public override object pbEffect(Battle.Battler attacker, Battle.Battler opponent, byte hitnum=0, byte? alltargets=null, bool showanimation=true){
		...
		hp=attacker.RecoverHP(attacker.TotalHP-attacker.HP,true)
		...
		if (opponent.damagestate.CalcDamage>0){
		  ...
		  if (opponent.hasWorkingAbility(Abilities.LIQUIDOOZE)){
			...
			//battle.pbDisplay(_INTL("{1} sucked up the liquid ooze!",attacker.pbThis))
				...
				if (attacker.hasWorkingItem(Items.BIGROOT)) hpgain = (int)Math.Floor(hpgain * 1.3f);
	...
	public class PokeBattle_Move_0E0 : PokeBattle_Move
	{
		public object pbOnStartUse(Battle.Battler attacker){
		if (!attacker.hasMoldBreaker()){
			bearer = this.battle.pbCheckGlobalAbility(Abilities.DAMP);
		  if (bearer!=null){
	...
	public class PokeBattle_Move_0E1 : PokeBattle_Move
	{
	  ...
	  public object pbShowAnimation(Movesid, Battle.Battler attacker, Battle.Battler opponent, byte hitnum= 0, byte? alltargets= null, bool showanimation= true){
	...
	{
		public override object pbEffect(Battle.Battler attacker, Battle.Battler opponent, byte hitnum=0, byte? alltargets=null, bool showanimation=true){
		if (attacker.OpposingSide.effects.Spikes>=3){
		  //battle.pbDisplay(_INTL("But it failed!"))
		  return -1;
		}
		pbShowAnimation(this.id, attacker, null, hitnum, alltargets, showanimation);
	...
	{
		public override object pbEffect(Battle.Battler attacker, Battle.Battler opponent, byte hitnum=0, byte? alltargets=null, bool showanimation=true){
		if (attacker.OpposingSide.effects.ToxicSpikes>=2){
		  //battle.pbDisplay(_INTL("But it failed!"))
		  return -1;
		}
		pbShowAnimation(this.id, attacker, null, hitnum, alltargets, showanimation);
	...
	{
		public override object pbEffect(Battle.Battler attacker, Battle.Battler opponent, byte hitnum=0, byte? alltargets=null, bool showanimation=true){
		if (attacker.OpposingSide.effects.StealthRock){
		  //battle.pbDisplay(_INTL("But it failed!"))
		  return -1;
		}
		pbShowAnimation(this.id, attacker, null, hitnum, alltargets, showanimation);
	...
	public class PokeBattle_Move_138 : PokeBattle_Move
	{
		...
		object ret=attacker.pbIncreaseStat(Stats.SPDEF,1,attacker,false,this);
		return ret? 0 : -1;
	  }
	}
	...
	{
		public override object pbEffect(Battle.Battler attacker, Battle.Battler opponent, byte hitnum=0, byte? alltargets=null, bool showanimation=true){
		if (attacker.OpposingSide.effects.StickyWeb){
		  //battle.pbDisplay(_INTL("But it failed!"))
		  return -1;
		}
		pbShowAnimation(this.id, attacker, null, hitnum, alltargets, showanimation);
