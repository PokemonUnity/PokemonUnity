...
{
	public Battle.InBattleMove CalcMoveFunc (Battle.InBattleMove move)//(ref Battle.InBattleMove move)
	{
		//Effect function;
		switch ((Effect)move.Function)
		{
			case Effect.Confusion:
				//battle		= battle
				move.BaseDamage	= 40;
				move.Type		= Types.NONE;
				move.Accuracy	= 100;
				move.PP			= -1;
				//move.TotalPP	= ;
				move.AddlEffect	= 0;
				move.Targets	= PokemonEssential.Target.NoTarget;
				move.Priority	= 0;
				move.Flag		= new PokemonEssential.Flags();
				//thismove		= move
				//name			= ""
				move.MoveId		= Moves.NONE;
...
public class PokeBattle_Move : IPokeBattle_Move
{
...
namespace PokemonUnity
{
	...
	//{
	//	/* Get Description Attribute of an Enum as String
