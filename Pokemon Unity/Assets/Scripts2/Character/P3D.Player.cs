...
namespace P3D
{
	public class Player //: System.Security.HashSecureBase
	{
		...
		//public List<PokemonUnity.Inventory.Inventory.Mail.MailData> Mails = new List<PokemonUnity.Inventory.Inventory.Mail.MailData>();
		...
		public void LoadGame(string filePrefix)
		{
			...
			//{
			//	// Check Inventory.
			//	Inventory.RemoveItem((PokemonUnity.Inventory.Items)501);
			//	//Inventory.Remove((PokemonUnity.Inventory.Items)501);
			//	for (int i = 507; i >= 553; i += +1)
			//		Inventory.RemoveItem((PokemonUnity.Inventory.Items)i);
			//		//Inventory.Remove((PokemonUnity.Inventory.Items)i);
			//
			//	// Check Party Pokemon.
			//	foreach (Pokemon Pokemon in Pokemons)
			//	{
			//		if (Pokemon.Inventory != PokemonUnity.Inventory.Items.NONE && (Pokemon.Inventory >= (PokemonUnity.Inventory.Items)501 || (Pokemon.Inventory >= (PokemonUnity.Inventory.Items)507 && Pokemon.Inventory <= (PokemonUnity.Inventory.Items)553)))
			//			//Pokemon.Inventory = PokemonUnity.Inventory.Items.NONE;
			//			Pokemon.SwapItem(PokemonUnity.Inventory.Items.NONE);
			//	}
			//
			//	// Check PC Boxes.
			...
			//
			//				if (TempPokemon.Inventory != PokemonUnity.Inventory.Items.NONE && (TempPokemon.Inventory >= (PokemonUnity.Inventory.Items)501 || (TempPokemon.Inventory >= (PokemonUnity.Inventory.Items)507 && TempPokemon.Inventory <= (PokemonUnity.Inventory.Items)553)))
			//					//TempPokemon.Inventory = PokemonUnity.Inventory.Items.NONE;
			//					TempPokemon.SwapItem(PokemonUnity.Inventory.Items.NONE);
			//
			...
			if (Data != "")
			{
				...
				foreach (string ItemDat in ItemData)
				{
					if (ItemDat != "" & ItemDat.StartsWith("{") & ItemDat.EndsWith("}") & ItemDat.Contains("|"))
					{
						...
						Inventory.AddItem((PokemonUnity.Inventory.Items)System.Convert.ToInt32(ItemID), amount);
					}
		...
		{
			Inventory.RemoveItem((PokemonUnity.Inventory.Items)177); // Removing Sport Balls if player has those.
